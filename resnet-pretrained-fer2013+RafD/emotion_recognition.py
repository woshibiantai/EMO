...
if __name__ == "__main__":
    ...
    X = np.asarray(genfromtxt('fer2013_RafD_data/fer2013_rafd_Training_Data.csv', delimiter=' ',  skip_header=1,  dtype=float))
    Y = np.asarray(genfromtxt('fer2013_RafD_data/fer2013_rafd_Training_Labels.csv', delimiter=' ', skip_header=1, dtype=int))

    X_test = np.asarray(genfromtxt('fer2013_RafD_data/fer2013_rafd_Test_Data.csv', delimiter=' ',  skip_header=1,  dtype=float))
    Y_test = np.asarray(genfromtxt('fer2013_RafD_data/fer2013_rafd_Test_Labels.csv', delimiter=' ', skip_header=1, dtype=int))
    predict_value = np.asarray(genfromtxt('fer2013_RafD_data/test_image.csv', delimiter=' ', dtype=float))
    ...
    print("training..........")
    # Training
    model = tflearn.DNN(net, checkpoint_path='fer2013-rafd-model/fer2013-rafd-model',
    ...
    model.save('fer2013-rafd-model/model.tfl')
