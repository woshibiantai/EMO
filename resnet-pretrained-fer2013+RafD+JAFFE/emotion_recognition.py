...
if __name__ == "__main__":
    ...
    X = np.asarray(genfromtxt('fer2013_RafD_jaffe_data/fer2013_rafd_jaffe_Training_Data.csv', delimiter=' ',  skip_header=1,  dtype=float))
    Y = np.asarray(genfromtxt('fer2013_RafD_jaffe_data/fer2013_rafd_jaffe_Training_Labels.csv', delimiter=' ', skip_header=1, dtype=int))
    ...
    predict_value = np.asarray(genfromtxt('fer2013_RafD_jaffe_data/test_image.csv', delimiter=' ', dtype=float))
    ...
    print("training..........")
    # Training
    model = tflearn.DNN(net, checkpoint_path='fer2013-rafd-jaffe-model/fer2013-rafd-jaffe-model',
    ...
    model.save('fer2013-rafd-jaffe-model/model.tfl')
